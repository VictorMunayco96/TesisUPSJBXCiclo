 ...
 * @author VictorHugo
 */
public class PDetalleVenta extends javax.swing.JFrame {

    /**
     * Creates new form PDetalleVenta
     */
    public PDetalleVenta() {
        initComponents();
        GetTabla("", "R");
...
public void MensajeConfirm(String Mensaje) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            Double Monto=Double.parseDouble(TxtCantidad.getText())*Double.parseDouble(TblProducto.getValueAt(TblProducto.getSelectedRow(), 5).toString());

                try {
                    DetalleVenta.NSetNegDetalleVenta(0,Validate.Number(TxtIdVenta.getText()), Integer.parseInt(TblProducto.getValueAt(TblProducto.getSelectedRow(), 0).toString()),Double.parseDouble(TxtCantidad.getText()),
                            Monto, "I"        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PDetalleVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PDetalleVenta().setVisible(true);
            }
        });
    }
